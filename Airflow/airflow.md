# Airflow
## Passo a Passo para Instalar Airflow
Este comando serão usado para instalar, configurar e iniciar o Airflow com Docker. 
Você pode copiar estes comandos para não precisar digitar, mas é imporante você seguir as orientações da aula.
...
**Nota**: este é só um exemplo
http://ec2-98-93-223-213.compute-1.amazonaws.com:8080/
airflow
...
## Reinicie em outro dia:
sh -i keynovadrive.pem ubuntu@ec2-98-93-223-213.compute-1.amazonaws.com
sudo docker compose up -d
sudo docker ps
